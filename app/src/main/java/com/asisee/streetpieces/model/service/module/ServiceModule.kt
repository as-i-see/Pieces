...
abstract class ServiceModule {
  ...
  @Binds
  abstract fun provideMyStorageService(impl: PieceStorageServiceImpl): PieceStorageService

  @Binds
  abstract fun providePhotoService(impl: PhotoStorageServiceImpl): PhotoStorageService

  @Binds
  abstract fun provideUserDataStorageService(impl: UserDataStorageServiceImpl): UserDataStorageService

  @Binds
  abstract fun provideSubscriptionStorageService(impl: SubscriptionStorageServiceImpl) : SubscriptionStorageService
}
