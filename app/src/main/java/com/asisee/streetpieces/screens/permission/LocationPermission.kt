...
fun RequestLocationPermissionDialog() {
    RequestPermissionsDialog(title = AppText.location_permission_title, text = AppText.location_permission_text, rationale = AppText.location_permission_rationale,
        listOf(
